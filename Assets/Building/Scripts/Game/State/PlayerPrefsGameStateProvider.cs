...
namespace Building.Scripts.Game.State
{
    public class PlayerPrefsGameStateProvider : IGameStateProvider
    {
        ...
        public Observable<GameStateProxy> LoadGameState()
        {
            if (!PlayerPrefs.HasKey(GAME_STATE_KEY))
            {
                ...
                Debug.Log("Game state was created from settings: " + JsonUtility.ToJson(_gameStateOrigin));
            ...
            else
            {
                ...
                Debug.Log("Game state was loaded: " + json);
            }
