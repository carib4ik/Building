...
namespace Building.Scripts.DI
{
    public class DIContainer
    {
        ...
        public T Resolve<T>(string tag = null)
        {
            ...
            {
                throw new Exception($"Cyclic dependency for tag {key.Item1} and type {key.Item2.FullName} has already registered");
            }
            ...
            throw new Exception($"Couldn't find dependency for tag {key.Item1} and type {key.Item2.FullName}");
        }
